                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('courses.destroy', $item->id) }}" method="post">
                                                ...
                                                <a href="{{ route('courses.show', $item->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Show</a>
                                                <a href="{{ route('courses.edit', $item->id) }}" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i> Edit</a>   
                        ...
                        <a href="{{ url('/courses/create') }}" class="btn btn-success btn-sm" title="add new student">
                            <i class="fa fa-plus" aria-hidden="true"> Add New Course</i>
                        </a><br>
                    </div>
                </div>
    </div>
